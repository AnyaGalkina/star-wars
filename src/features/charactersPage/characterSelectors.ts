...
export const getCharactersOnPage = (state: RootState): CharacterType[] => state.characters.charactersOnPage;
export const getPrevCharactersOnPage = (state: RootState): CharacterType[] => state.characters.prevCharactersOnPage;
export const getCharacter = (state: RootState): CharacterType => state.characters.character;
